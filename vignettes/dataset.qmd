...
* 1st column: the name of the state / prefecture
* 2nd column: the name of the district
* 3rd column: the electorates of the district
* 4th column: the magnitudes of the district

|Name|Country|Year|
|:---|:---|---:|
|`au_district_2010`|Australia|2010|
