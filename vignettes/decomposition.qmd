...
(decompose_1972 <- decompose3(nz_1972, special = "Maori"))
(decompose_1990 <- decompose3(nz_1990, special = "Maori"))
(decompose_2011 <- decompose3(nz_2011, special = "Maori"))
...
nz_decompose_all <- nz_district |> 
  ...
  mutate(data      = map(data, \(x) as_prcalc(x)),
         decompose = map(data, \(x) decompose3(x, special = "Maori"))) |> 
  pull(decompose)
